$(function () {
    //navbar 的ajax请求
    $.ajax({
        url: "http://192.168.70.64:9900/api/nav",
        dataType: "json",
    ...
    //侧栏的ajax请求
    $.ajax({
        url: "http://192.168.70.64:9900/api/items",
        dataType: "json",
        success: function (data) {
    ...
    // 轮播图的ajax请求
    $.ajax({
        url: "http://192.168.70.64:9900/api/lunbo",
        dataType: "json",
        success: function (data) {
    ...
    // 智能硬件的 ajax请球
    $.ajax({
        url: "http://192.168.70.64:9900/api/hardware",
        dataType: "json",
        success: function (data) {
            var hardware = {
                list: data
    ...
    //搭配 的ajax请求
    $.ajax({
        url: "http://192.168.70.64:9900/api/product",
        data: {
            toptitle: "match"
        },
        dataType: "json",
    ...
    //热门评论 ajax请求
    $.ajax({
        url: "http://192.168.70.64:9900/api/hotcomment",
        dataType: "json",
        success: function (data) {
            // console.log(data);
            var hotcomment = {
    ...
    //内容 ajax请求
    $.ajax({
        url: "http://192.168.70.64:9900/api/content",
        dataType: "json",
        success: function (data) {
            // console.log(data);
    ...
    // 视频的 ajax请求
    $.ajax({
        url: "http://192.168.70.64:9900/api/video",
        dataType: "json",
        success: function (data) {
            // console.log(data);
